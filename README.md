...
* [original design](https://goo.gle/nia-figma)
* see
...
* == FULLY functional Android app / built with Kotlin + Jetpack Compose
  * `prodRelease` variant is [available | Play Store](https://play.google.com/store/apps/details?id=com.google.samples.apps.nowinandroid)

# Features

* [Now in Android](https://developer.android.com/series/now-in-android) series' content
  * users can browse for links to
    * recent videos,
    * articles

## Screenshots

![For You screen -- Interests screen -- Topic detail screen](docs/images/screenshots.png)

# Development Environment

* recommendations
  * use [the latest stable Android Studio version](https://developer.android.com/studio)
...
* follows the [official architecture guidance](https://developer.android.com/topic/architecture) 
  * see [architecture learning journey](docs/ArchitectureLearningJourney.md)

# Modularization

* FULLY modularized
  * see [modularization learning journey](docs/ModularizationLearningJourney.md)
...
* build variants
  ...
  * `app-nia-catalog`
    * == standalone app / displays the list of components / -- are stylized for -- **Now in Android**
  ...
  * `demo` flavor
    * uses static local data
      * -> IMMEDIATE building and exploring of the UI
  * `prod` flavor
    * use a backend server / NOT currently publicly available
      * -> up-to-date content
  * `demoDebug` and `demoRelease`
    * can be built and run
    * `demoDebug`
      * uses it | normal development
    * `demoRelease`
